...
public class irasunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_irasun);

        backmain = (Button) findViewById(R.id.backButton);
        backmain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(irasunActivity.this, MainActivity.class));
            }
        });

        Uri insta_uri = Uri.parse("https://www.instagram.com/irasun_official/");
